...
scope = 'wallet:accounts:read,wallet:payment-methods:read,wallet:deposits:create,wallet:buys:create,wallet:buys:read,wallet:sells:create,wallet:sells:read,wallet:withdrawals:create,wallet:user:read,wallet:user:email'
